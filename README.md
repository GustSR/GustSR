...
**Bancos de dados** — PostgreSQL · MySQL · MongoDB · Redis · ClickHouse · SQLite<br>
Modelagem, tuning, FDW, réplica, migração entre versões e auditoria de triggers e functions.
